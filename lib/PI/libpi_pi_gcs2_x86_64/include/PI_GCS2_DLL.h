...
BOOL PI_FUNC_DECL PI_WAV_SWEEP(
    ...
    int  iWaveTableId,
    int iAddAppendWave,
    unsigned int iStartFrequencyValueInPoints,
...
BOOL PI_FUNC_DECL PI_qDRL(
    int ID,
    const int* piRecordChannelIdsArray,
    int* piNumberOfRecordedValuesArray,
    int iArraySize);
