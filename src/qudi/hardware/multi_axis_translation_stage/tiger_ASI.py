# -*- coding: utf-8 -*-
"""
Author: F.Barho - adapted for qudi-core-HiM and Tiger controller by JB Fiche
Created: 2026-09-08
This file contains a class for the ASI Tiger translation stage. Most of the commands are similar to the ones used for
the MS2000 stage but some are slightly different and it was easier to create a dedicated class.
...
class Tiger(MultiAxisStageInterface):
  ...
  ms2000:
    ...
    _card_address = ConfigOption("card_address", 1, missing="warn", converter=int)
    ...
    def led_control(self, intens):
        ...
        return self.write(f'{self._card_address}LED X={value}? \r')
